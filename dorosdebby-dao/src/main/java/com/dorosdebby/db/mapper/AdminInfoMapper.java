package com.dorosdebby.db.mapper;

import java.util.List;

import org.apache.ibatis.annotations.Param;

import com.dorosdebby.db.model.AdminInfo;
import com.dorosdebby.db.model.AdminInfoExample;
...
public interface AdminInfoMapper {
    ...
    int batchInsert(@Param("recordList") List<AdminInfo> recordList);

    int batchUpdate(@Param("recordList") List<AdminInfo> recordList);
}